...
export default function ManagedSidebar() {
    ...
    <>
      ...
      <div className="lg:hidden bg-slate-900 text-white px-4 py-3 flex items-center justify-between sticky top-0 z-40">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-black text-lg tracking-tight">Managed <span className="text-emerald-400 text-xs">Sales</span></span>
        </Link>
        <button
        ...
        <div>
          ...
          <div className="p-5 border-b border-slate-800/80">
            <Link to="/" className="flex items-center gap-2.5">
              <div className="w-9 h-9 bg-emerald-600 rounded-xl flex items-center justify-center text-white shadow-md shadow-emerald-600/30">
                <Zap className="w-5 h-5" />
              </div>
              <div>
                <h1 className="font-black text-white text-base tracking-tight leading-none">Managed Sales</h1>
                <span className="text-[10px] font-semibold text-emerald-400 tracking-wide">Full-Service Portal</span>
              </div>
            </Link>
          </div>

          {/* Assigned Manager Card */}
          <div className="m-3 p-3 bg-emerald-950/60 rounded-xl border border-emerald-800/40 text-xs">
            <div className="flex items-center gap-2 mb-1 text-emerald-400 font-bold">
              <UserCheck className="w-4 h-4" />
              <span>Assigned E-SHOP Manager</span>
            </div>
            <div className="text-white font-bold">Kavya Nair</div>
            <div className="text-[10px] text-slate-400">+91 98470 99887</div>
          </div>

          {/* Navigation Links */}
          <nav className="p-3 space-y-1.5">
            <div className="px-3 text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">Merchant Menu</div>
            {menuItems.map((item) => {
