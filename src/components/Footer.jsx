...
export default function Footer() {
  ...
  const shopLinks = [
    ...
    { to: '/categories', label: 'Electronics & Gadgets' },
    { to: '/categories', label: 'Fashion & Apparel' },
  ...
  const supportLinks = [
    ...
    { to: '#order-status', label: 'Order Tracking' },
            ...
            <div className="lg:col-span-1">
              ...
              <ul className="space-y-3 text-[13px]">
                {supportLinks.map((link) => (
                  <li key={link.label}>
                    <a href={link.to} className="transition-colors hover:text-primary">
                      {link.label}
                    </a>
                  </li>
                ))}
